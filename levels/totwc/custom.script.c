...
const LevelScript local_objects_totwc_1_[] = {
	OBJECT_WITH_ACTS(0, 52, 1099, -3542, 0, 0, 0, 0xa0000,  bhvSpinAirborneWarp, 31),
	...
	OBJECT_WITH_ACTS(221, -313, -411, -2396, 0, -180, 0, 0x51000000,  bhvToadMessage, 31),
	OBJECT_WITH_ACTS(221, 1563, -411, 990, 0, 144, 0, 0x47000000,  bhvToadMessage, 31),
	OBJECT_WITH_ACTS(221, -2135, -411, 1146, 0, -131, 0, 0x4e000000,  bhvToadMessage, 31),
	OBJECT_WITH_ACTS(121, 0, 846, -156, 0, 180, 0, 0x0,  bhvStar, 31),
	OBJECT_WITH_ACTS(0, 0, 58, -3021, 0, 0, 0, 0xf10000,  bhvPaintingDeathWarp, 31),
	OBJECT_WITH_ACTS(212, -1250, 565, -1667, 0, 0, 0, 0x0,  bhv1Up, 31),
	OBJECT_WITH_ACTS(212, 1146, 565, 1615, 0, 0, 0, 0x0,  bhv1Up, 31),
	RETURN()
};
